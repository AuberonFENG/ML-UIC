# this file is for efficient net B0 
# ref:https://keras.io/api/applications/efficientnet/#efficientnetb4-functionv
...
#  visualization show acc and loss on training set and dev set
